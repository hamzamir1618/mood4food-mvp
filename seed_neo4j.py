...
DISHES = [
    ...
    (
        ...
        8.0,
        300,
        ["lentils", "yogurt", "dairy", "onion", "cumin", "chili", "coriander", "tamarind", "salt"],
        "Vegetarian",
    ...
    (
        ...
        12.0,
        400,
        ["egg", "rice", "onion", "garlic", "peas", "carrot", "soy sauce", "oil", "salt"],
        "Egg",
    ...
    (
        ...
        15.0,
        420,
        ["egg", "flour", "wheat", "gluten", "onion", "tomato", "chili", "oil", "salt"],
        "Egg",
    ...
    (
        ...
        3.0,
        260,
        ["flour", "wheat", "gluten", "yogurt", "dairy", "sugar", "salt", "oil"],
        "Bread",
    ...
    (
        ...
        4.0,
        290,
        ["flour", "wheat", "gluten", "garlic", "butter", "dairy", "salt", "oil"],
        "Bread",
    ...
    (
        ...
        10.0,
        350,
        ["rice", "lentils", "onion", "garlic", "turmeric", "cumin", "ghee", "salt"],
        "Lentil/Rice",
    ...
    (
        ...
        6.0,
        350,
        ["rice", "milk", "dairy", "sugar", "cashew", "nuts", "raisin", "cardamom", "salt"],
        "Sweet/Dessert",
    ...
    (
        ...
        3.0,
        400,
        ["milk", "dairy", "flour", "wheat", "gluten", "sugar", "ghee", "cardamom"],
        "Sweet/Dessert",
    ...
    (
        ...
        3.0,
        300,
        ["semolina", "wheat", "gluten", "sugar", "ghee", "cashew", "nuts", "raisin", "cardamom"],
        "Sweet/Dessert",
    ...
    (
        ...
        5.0,
        350,
        ["chickpeas", "onion", "potato", "spinach", "chili", "cumin", "turmeric", "oil", "salt"],
        "Street Food",
    ...
    (
        ...
        5.0,
        120,
        ["yogurt", "dairy", "cucumber", "onion", "mint", "cumin", "salt"],
        "Fresh/Light",
    ...
    (
        ...
        3.0,
        160,
        ["pomegranate", "cucumber", "lettuce", "onion", "mint", "lemon", "sesame", "oil", "salt"],
        "Fresh/Light",
...
def main():
    ...
    with driver.session() as session:
        ...
        cat_count = session.run(
            "MATCH (d:Dish) WHERE d.category IS NOT NULL RETURN count(DISTINCT d.category) AS c"
        ).single()["c"]
        tag_count = session.run(
            "MATCH (d:Dish) WHERE d.human_tags IS NOT NULL RETURN count(d) AS c"
        ).single()["c"]
        taste_count = session.run(
            "MATCH (d:Dish) WHERE d.taste_sweet IS NOT NULL RETURN count(d) AS c"
        ).single()["c"]
